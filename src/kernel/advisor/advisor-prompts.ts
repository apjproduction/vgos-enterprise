export const advisorSuggestedQuestions = [
  ...
  "Which commitment produced the best result?",
  "Which outcome has unclear attribution?",
  "Which claim was validated?",
  "Which assumption was weakened?",
  "Which capability improved?",
  "Which completed commitment lacks outcome evaluation?",
  "Was this decision good or just lucky?",
  "What should we remember for future decisions?",
  "What is blocked?",
